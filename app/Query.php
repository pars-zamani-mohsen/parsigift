...
class Query extends Model
{
     ...
     * @var string[]
     */
    public static $modulefields = array('id', 'title', 'url', 'active', 'created_at', 'updated_at', 'created_by');
    ...
    {
        return Query::select(self::$modulefields)->with(['publisher'])->orderBy('id', 'DESC')->paginate($limit);
    }
    ...
    {
        return Query::select('id', 'title', 'amount', 'qty', 'active', 'created_at', 'created_by')->onlyTrashed()->paginate($limit);
    }
    ...
    {
        return Query::select(self::$modulefields)->active()->get();
    }
