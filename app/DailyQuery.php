...
class DailyQuery extends Model
{
    use SoftDeletes;
     ...
     * @var string[]
     */
    public static $modulename = array('en' => 'dailyQuery', 'fa' => 'کوئری روزانه', 'model' => 'DailyQuery');

    /**
     * module fields for select and search
     * @var string[]
     */
    public static $modulefields = array('id', 'user_id', 'query_id', 'status', 'created_at', 'updated_at');
...
//    }
    ...
    {
        return DailyQuery::select('id', 'title', 'amount', 'qty', 'active', 'created_at', 'created_by')->onlyTrashed()->paginate($limit);
    }
    ...
    {
        return DailyQuery::select(self::$modulefields)->active()->get();
    }
