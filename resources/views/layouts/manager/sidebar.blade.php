...
{{--
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        @php  $moduleModel = '\App\Blog_category';  $url = '/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/' . $moduleModel::$modulename['en']; @endphp
                        <li class="submenu-item" data-url="{{ $url }}">
                            <a href="{{ url($url) }}"><i class="bi bi-journals bi-line-height"></i>{{ $moduleModel::$modulename['fa'] }}</a>
                        </li>
                        @php  $moduleModel = '\App\Blog';  $url = '/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/' . $moduleModel::$modulename['en']; @endphp
                        <li class="submenu-item" data-url="{{ $url }}">
                            <a href="{{ url($url) }}"><i class="bi bi-journal-richtext bi-line-height"></i> {{ $moduleModel::$modulename['fa'] }} </a>
                        </li>
                    </ul>
                </li>
--}}
